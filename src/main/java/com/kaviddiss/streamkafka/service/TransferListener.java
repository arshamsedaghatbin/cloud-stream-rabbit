...
public class TransferListener {
    ...
    public void handleGreetings(@Payload MasterTransferDTO masterTransfer, @Header(AmqpHeaders.CHANNEL) Channel channel, @Header(AmqpHeaders.DELIVERY_TAG) Long deliveryTag) throws Exception {
